		...
		try{
			if ((contextEventJson != null)&&(contextEventType != null)){
				...
				if (contextEventType.equals(ActionType.OPEN_ASSET)||contextEventType.equals(ActionType.CREATE_ASSET)||contextEventType.equals(ActionType.MODIFY_ASSET)||contextEventType.equals(ActionType.DELETE_ASSET)||contextEventType.equals(ActionType.ACCESS)||contextEventType.equals(ActionType.OPEN)){
					...
					properties.put("event", contextEventType);
				}else if (contextEventType.equals(ActionType.USER_ENTERED_PASSWORD_FIELD)){
					contextEvent.setType(EventTypes.USER_ENTERED_PASSWORD_FIELD);
					properties.put("event", contextEventType);
				}else if (contextEventType.equals(ActionType.USB_DEVICE_CONNECTED)){
					contextEvent.setType(EventTypes.USB_DEVICE_CONNECTED);
					properties.put("event", contextEventType);

				}else if (contextEventType.equals(ActionType.ADD_NOTE)){
					contextEvent.setType(EventTypes.ADD_NOTE);
					properties.put("event", contextEventType);
